...
public class RepositoriesAPI {
	...
	@GET
	@Path("{repoId}/commits")
	public Collection<Commit> listCommits(@PathParam("repoId") String repoId) throws IOException, ServiceUnavailable,
			GitException {
	...
	public Collection<Diff> calculateDiff(@PathParam("repoId") String repoId, @PathParam("oldId") String oldId,
